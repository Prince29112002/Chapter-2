    ...
    <>
      <div className="main">
        <div className="container c1">
          ...
          <button onClick={listof} className="btn btn-primary">
            Submit
          </button>{" "}
          <span> Total : {count1}</span>{" "}
          <button className="btn btn-info" onClick={changei}>
            clear
          </button>
          <ol>
                ...
                <div>
                  ...
                  <li key={index1}>
                    ...
                    <i
                      ...
                      aria-hidden="true"
                      onClick={() => deleteitems(itemval)}
                    >
                      {" "}
                    </i>{" "}
                    {itemval}{" "}
                    <button className="pro" onClick={progChange}>
                      ⏳
                    </button>{" "}
                  </li>
                </div>
        ...
        <div className="container c2">
          ...
          <button onClick={listof2} className="btn btn-primary">
            Submit
          </button>{" "}
          <span>Total : {count2}</span>{" "}
          <button className="btn btn-info" onClick={changei2}>
            clear
          </button>
          <ol>
              ...
              return (
                <li key={index1}>
                  ...
                  <i
                    className="fa fa-trash-o"
                    aria-hidden="true"
                    onClick={() => deleteitems2(itemval)}
                  >
                    {" "}
                  </i>{" "}
                  {itemval}{" "}
                  <button onClick={compchange}>
                    <i className="fa fa-check" aria-hidden="true">MTC</i>
                  </button>{""}
                </li>
              );
            })}
        ...
        <div className="container c3">
          ...
          <button onClick={listof3} className="btn btn-primary">
            Submit
          </button>{" "}
          <span>Total : {count3}</span>{" "}
          <button className="btn btn-info" onClick={changei3}>
            clear
          </button>
          <ol>
